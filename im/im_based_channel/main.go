...
func serveHome(w http.ResponseWriter, r *http.Request) {
	http.ServeFile(w, r, "./im_based_channel/home.html") //请求根目录时直接返回一个html页面
}

func main() {
	port := flag.String("port", "5678", "http service port") //如果命令行不指定port参数，则默认为5657
...
// go run ./im/im_based_channel --port 5678
